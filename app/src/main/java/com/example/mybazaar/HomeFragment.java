...
import static com.example.mybazaar.DBqueries.categoryModelList;
import static com.example.mybazaar.DBqueries.firebaseFirestore;
import static com.example.mybazaar.DBqueries.lists;
import static com.example.mybazaar.DBqueries.loadCategories;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       //////categories fake list
        ...
        wishlistModelList.add(new WishlistModel("","","","","",true));
        wishlistModelList.add(new WishlistModel("","","","","",true));
        wishlistModelList.add(new WishlistModel("","","","","",true));
        wishlistModelList.add(new WishlistModel("","","","","",true));
        wishlistModelList.add(new WishlistModel("","","","","",true));
